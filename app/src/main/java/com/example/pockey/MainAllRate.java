...
public class MainAllRate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al = (TextView) findViewById(R.id.textfor);
...
//                try{
//                    Cursor AllIncomeCursor = db.rawQuery("select * FROM ftp_main where _id = " + id + "", null);
//                    AllIncomeCursor.moveToFirst();
//
//                    alo = AllIncomeCursor.getString(AllIncomeCursor.getColumnIndex(DatabaseHelper.CATEGORY));
//                    aloha = AllIncomeCursor.getInt(AllIncomeCursor.getColumnIndex(DatabaseHelper.SUM));
//                    AllIncomeCursor.close();
//                    //System.out.println(alo + " " + aloha);
//
//                }
//                catch (Exception ignored){}
                //System.out.println(alo + " fdfdsdfhsfd " + aloha);
                //al.setText("fjhdgsfhdgfhdgnfhdgfhdgnfhgd");
...
//        userList.setAdapter(userAdapter);
        ...
        userCursor = db.rawQuery("select * from " + DatabaseHelper.TABLE_MAIN + " where purpose = 'Расход'  order by " + DatabaseHelper._ID + " desc ", null );
        // определяем, какие столбцы из курсора будут выводиться в ListView
        ...
        userCursor1 = db.rawQuery("select * from " + DatabaseHelper.TABLE_MAIN + " where purpose = 'Расход' order by " + DatabaseHelper._ID + " desc ", null );
        // определяем, какие столбцы из курсора будут выводиться в ListView
        ...
        buttonPref.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                try{
                    Intent intent = new Intent(MainAllRate.this,MainActivity.class);
