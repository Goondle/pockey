...
public class MainAllincome extends AppCompatActivity {
...
//        userList.setAdapter(userAdapter);
        ...
        userCursor = db.rawQuery("select * from " + DatabaseHelper.TABLE_MAIN + " where purpose = 'Доход'  order by " + DatabaseHelper._ID + " desc ", null );
        // определяем, какие столбцы из курсора будут выводиться в ListView
        ...
        userCursor1 = db.rawQuery("select * from " + DatabaseHelper.TABLE_MAIN + " where purpose = 'Доход' order by " + DatabaseHelper._ID + " desc ", null );
        // определяем, какие столбцы из курсора будут выводиться в ListView
        ...
        buttonPref.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                try{
                    Intent intent = new Intent(MainAllincome.this,MainActivity.class);
